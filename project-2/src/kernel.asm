...
80101255:	e8 c6 31 00 00       	call   80104420 <memset>
  log_write(bp);
...
8010129a:	e8 81 30 00 00       	call   80104320 <acquire>
...
801012df:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012e2:	e8 e9 30 00 00       	call   801043d0 <release>
      return ip;
...
8010132f:	e8 9c 30 00 00       	call   801043d0 <release>
...
80101441:	e8 8a 30 00 00       	call   801044d0 <memmove>
  brelse(bp);
...
80101476:	e8 45 2d 00 00       	call   801041c0 <initlock>
...
8010148f:	e8 fc 2b 00 00       	call   80104090 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
8010156e:	e8 ad 2e 00 00       	call   80104420 <memset>
      dip->type = type;
...
80101611:	e8 ba 2e 00 00       	call   801044d0 <memmove>
  log_write(bp);
...
8010163f:	e8 dc 2c 00 00       	call   80104320 <acquire>
  ip->ref++;
80101644:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101648:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010164f:	e8 7c 2d 00 00       	call   801043d0 <release>
  return ip;
}
...
80101682:	e8 49 2a 00 00       	call   801040d0 <acquiresleep>
...
801016f8:	e8 d3 2d 00 00       	call   801044d0 <memmove>
    brelse(bp);
...
80101753:	e8 18 2a 00 00       	call   80104170 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
8010176f:	e9 bc 29 00 00       	jmp    80104130 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
801017a0:	e8 2b 29 00 00       	call   801040d0 <acquiresleep>
...
801017ba:	e8 71 29 00 00       	call   80104130 <releasesleep>

  acquire(&icache.lock);
801017bf:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017c6:	e8 55 2b 00 00       	call   80104320 <acquire>
  ip->ref--;
...
801017df:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017e0:	e9 eb 2b 00 00       	jmp    801043d0 <release>
...
801017f0:	e8 2b 2b 00 00       	call   80104320 <acquire>
    int r = ip->ref;
801017f5:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
801017f8:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017ff:	e8 cc 2b 00 00       	call   801043d0 <release>
    if(r == 1){
...
801019e8:	e8 e3 2a 00 00       	call   801044d0 <memmove>
    brelse(bp);
...
80101ae4:	e8 e7 29 00 00       	call   801044d0 <memmove>
    log_write(bp);
...
80101b7e:	e8 cd 29 00 00       	call   80104550 <strncmp>
}
80101b83:	c9                   	leave  
80101b84:	c3                   	ret    
...
80101be5:	e8 66 29 00 00       	call   80104550 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101c69:	e8 b2 26 00 00       	call   80104320 <acquire>
  ip->ref++;
80101c6e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c72:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c79:	e8 52 27 00 00       	call   801043d0 <release>
...
80101cd5:	e8 f6 27 00 00       	call   801044d0 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d64:	e8 67 27 00 00       	call   801044d0 <memmove>
    name[len] = 0;
...
80101e4d:	e8 6e 27 00 00       	call   801045c0 <strncpy>
  de.inum = inum;
...
80101e98:	68 82 76 10 80       	push   $0x80107682
...
80101fd0:	e8 eb 21 00 00       	call   801041c0 <initlock>
...
8010204e:	e8 cd 22 00 00       	call   80104320 <acquire>
...
8010209c:	e8 2f 23 00 00       	call   801043d0 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020ee:	e8 7d 20 00 00       	call   80104170 <holdingsleep>
...
80102128:	e8 f3 21 00 00       	call   80104320 <acquire>
...
80102195:	c9                   	leave  
  ...
  release(&idelock);
80102196:	e9 35 22 00 00       	jmp    801043d0 <release>
...
80102302:	e8 19 21 00 00       	call   80104420 <memset>
...
8010233a:	c9                   	leave  
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
8010233b:	e9 90 20 00 00       	jmp    801043d0 <release>
...
80102348:	e8 d3 1f 00 00       	call   80104320 <acquire>
...
801023c5:	e8 f6 1d 00 00       	call   801041c0 <initlock>
...
801024ae:	e8 1d 1f 00 00       	call   801043d0 <release>
...
801024c8:	e8 53 1e 00 00       	call   80104320 <acquire>
  r = kmem.freelist;
...
801028d4:	e8 97 1b 00 00       	call   80104470 <memcmp>
...
80102a04:	e8 c7 1a 00 00       	call   801044d0 <memmove>
...
80102ab4:	e8 07 17 00 00       	call   801041c0 <initlock>
  readsb(dev, &sb);
80102ab9:	58                   	pop    %eax
...
80102b4b:	e8 d0 17 00 00       	call   80104320 <acquire>
...
80102b9c:	e8 2f 18 00 00       	call   801043d0 <release>
      break;
    }
  }
}
...
80102bbe:	e8 5d 17 00 00       	call   80104320 <acquire>
  log.outstanding -= 1;
...
80102bfd:	e8 ce 17 00 00       	call   801043d0 <release>
}
...
80102c5c:	e8 6f 18 00 00       	call   801044d0 <memmove>
...
80102ca5:	e8 76 16 00 00       	call   80104320 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80102cc7:	e8 04 17 00 00       	call   801043d0 <release>
...
80102cf4:	e8 d7 16 00 00       	call   801043d0 <release>
...
80102d5e:	e8 bd 15 00 00       	call   80104320 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dad:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dae:	e9 1d 16 00 00       	jmp    801043d0 <release>
80102db3:	90                   	nop
...
80102ec9:	e8 02 16 00 00       	call   801044d0 <memmove>
...
80102f9e:	e8 cd 14 00 00       	call   80104470 <memcmp>
...
80103062:	e8 09 14 00 00       	call   80104470 <memcmp>
...
80103259:	e8 62 0f 00 00       	call   801041c0 <initlock>
  (*f0)->type = FD_PIPE;
...
801032ef:	e8 2c 10 00 00       	call   80104320 <acquire>
  if(writable){
...
80103333:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103334:	e9 97 10 00 00       	jmp    801043d0 <release>
...
80103364:	e8 67 10 00 00       	call   801043d0 <release>
    kfree((char*)p);
...
8010338d:	e8 8e 0f 00 00       	call   80104320 <acquire>
  for(i = 0; i < n; i++){
...
80103414:	e8 b7 0f 00 00       	call   801043d0 <release>
        return -1;
...
8010346b:	e8 60 0f 00 00       	call   801043d0 <release>
  return n;
...
80103490:	e8 8b 0e 00 00       	call   80104320 <acquire>
...
801034f9:	e8 d2 0e 00 00       	call   801043d0 <release>
      return -1;
...
80103566:	e8 65 0e 00 00       	call   801043d0 <release>
  return i;
...
801035b1:	e8 6a 0d 00 00       	call   80104320 <acquire>
...
801035ec:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
801035f2:	e8 d9 0d 00 00       	call   801043d0 <release>
...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 68 56 10 80 	movl   $0x80105668,0x14(%eax)
...
80103623:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103626:	e8 f5 0d 00 00       	call   80104420 <memset>
...
80103648:	e8 83 0d 00 00       	call   801043d0 <release>
  return 0;
...
8010366b:	e8 60 0d 00 00       	call   801043d0 <release>
...
801036c0:	e8 fb 0a 00 00       	call   801041c0 <initlock>
}
...
8010373a:	68 58 75 10 80       	push   $0x80107558
...
80103774:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103777:	e8 c4 0a 00 00       	call   80104240 <pushcli>
  c = mycpu();
8010377c:	e8 4f ff ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103781:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103787:	e8 f4 0a 00 00       	call   80104280 <popcli>
  return p;
}
...
801037e6:	e8 35 0c 00 00       	call   80104420 <memset>
...
80103845:	e8 d6 0d 00 00       	call   80104620 <safestrcpy>
  p->cwd = namei("/");
...
80103860:	e8 bb 0a 00 00       	call   80104320 <acquire>
...
80103873:	e8 58 0b 00 00       	call   801043d0 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103898:	e8 a3 09 00 00       	call   80104240 <pushcli>
  c = mycpu();
8010389d:	e8 2e fe ff ff       	call   801036d0 <mycpu>
  p = c->proc;
801038a2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038a8:	e8 d3 09 00 00       	call   80104280 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103919:	e8 22 09 00 00       	call   80104240 <pushcli>
  c = mycpu();
8010391e:	e8 ad fd ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103923:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103929:	e8 52 09 00 00       	call   80104280 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
801039c1:	e8 5a 0c 00 00       	call   80104620 <safestrcpy>
...
801039d0:	e8 4b 09 00 00       	call   80104320 <acquire>
...
801039e3:	e8 e8 09 00 00       	call   801043d0 <release>
...
80103a5e:	e8 bd 08 00 00       	call   80104320 <acquire>
...
80103a99:	c7 43 8c 04 00 00 00 	movl   $0x4,-0x74(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103aa0:	e8 d6 0b 00 00       	call   8010467b <swtch>
      switchkvm();
...
80103ac8:	e8 03 09 00 00       	call   801043d0 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ae5:	e8 56 07 00 00       	call   80104240 <pushcli>
  c = mycpu();
80103aea:	e8 e1 fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103aef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103af5:	e8 86 07 00 00       	call   80104280 <popcli>
sched(void)
{
  int intena;
...
80103b02:	e8 e9 07 00 00       	call   801042f0 <holding>
...
80103b43:	e8 33 0b 00 00       	call   8010467b <swtch>
  mycpu()->intena = intena;
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ba9:	e8 92 06 00 00       	call   80104240 <pushcli>
  c = mycpu();
80103bae:	e8 1d fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103bb3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bb9:	e8 c2 06 00 00       	call   80104280 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103c12:	e8 09 07 00 00       	call   80104320 <acquire>
...
80103cdc:	e8 3f 06 00 00       	call   80104320 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103ce1:	e8 5a 05 00 00       	call   80104240 <pushcli>
  c = mycpu();
80103ce6:	e8 e5 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103ceb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cf1:	e8 8a 05 00 00       	call   80104280 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d09:	e8 c2 06 00 00       	call   801043d0 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d2f:	e8 0c 05 00 00       	call   80104240 <pushcli>
  c = mycpu();
80103d34:	e8 97 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103d39:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d3f:	e8 3c 05 00 00       	call   80104280 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d60:	e8 bb 05 00 00       	call   80104320 <acquire>
    release(lk);
80103d65:	89 34 24             	mov    %esi,(%esp)
80103d68:	e8 63 06 00 00       	call   801043d0 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d8a:	e8 41 06 00 00       	call   801043d0 <release>
    acquire(lk);
...
80103d9b:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103d9c:	e9 7f 05 00 00       	jmp    80104320 <acquire>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103de5:	e8 56 04 00 00       	call   80104240 <pushcli>
  c = mycpu();
80103dea:	e8 e1 f8 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103def:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103df5:	e8 86 04 00 00       	call   80104280 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103e02:	e8 19 05 00 00       	call   80104320 <acquire>
...
80103e42:	74 76                	je     80103eba <wait+0xda>
80103e44:	8b 46 24             	mov    0x24(%esi),%eax
80103e47:	85 c0                	test   %eax,%eax
80103e49:	75 6f                	jne    80103eba <wait+0xda>
      release(&ptable.lock);
      return -1;
    }
...
80103e67:	ff 73 08             	pushl  0x8(%ebx)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
...
80103e6a:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103e6d:	e8 5e e4 ff ff       	call   801022d0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80103e72:	5a                   	pop    %edx
...
80103e76:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e7d:	e8 5e 2d 00 00       	call   80106be0 <freevm>
        p->pid = 0;
80103e82:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103e89:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103e90:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103e94:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103e9b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103ea2:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ea9:	e8 22 05 00 00       	call   801043d0 <release>
        return pid;
...
80103eb1:	8d 65 f8             	lea    -0x8(%ebp),%esp
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
...
80103ec2:	e8 09 05 00 00       	call   801043d0 <release>
      return -1;
...
801040f5:	e8 26 fc ff ff       	call   80103d20 <sleep>
...
80104103:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104109:	e8 62 f6 ff ff       	call   80103770 <myproc>
...
80104193:	e8 d8 f5 ff ff       	call   80103770 <myproc>
...
80104249:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010424a:	e8 81 f4 ff ff       	call   801036d0 <mycpu>
...
8010425f:	e8 6c f4 ff ff       	call   801036d0 <mycpu>
80104264:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010426a:	e8 61 f4 ff ff       	call   801036d0 <mycpu>
...
8010428b:	75 52                	jne    801042df <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010428d:	e8 3e f4 ff ff       	call   801036d0 <mycpu>
...
801042a5:	e8 26 f4 ff ff       	call   801036d0 <mycpu>
...
801042b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
801042c0:	e8 0b f4 ff ff       	call   801036d0 <mycpu>
...
801042d5:	68 ba 75 10 80       	push   $0x801075ba
...
801042e2:	68 a3 75 10 80       	push   $0x801075a3
...
80104308:	e8 c3 f3 ff ff       	call   801036d0 <mycpu>
...
80104364:	e8 67 f3 ff ff       	call   801036d0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
801043c3:	68 c1 75 10 80       	push   $0x801075c1
...
8010440c:	68 c9 75 10 80       	push   $0x801075c9
...
80104826:	83 ec 0c             	sub    $0xc,%esp
  int num;
  struct proc *curproc = myproc();
80104829:	e8 42 ef ff ff       	call   80103770 <myproc>

  num = curproc->tf->eax;
8010482e:	8b 70 18             	mov    0x18(%eax),%esi
...
80104831:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104833:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104836:	8d 50 ff             	lea    -0x1(%eax),%edx
80104839:	83 fa 15             	cmp    $0x15,%edx
8010483c:	77 22                	ja     80104860 <syscall+0x40>
...
8010484e:	ff d7                	call   *%edi
80104850:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104853:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104856:	5b                   	pop    %ebx
80104857:	5e                   	pop    %esi
80104858:	5f                   	pop    %edi
80104859:	5d                   	pop    %ebp
...
80104868:	68 d1 75 10 80       	push   $0x801075d1
...
80104899:	8b 73 18             	mov    0x18(%ebx),%esi
8010489c:	eb b0                	jmp    8010484e <syscall+0x2e>
...
801049e4:	68 78 76 10 80       	push   $0x80107678
...
801049fc:	68 77 76 10 80       	push   $0x80107677
...
80104a11:	68 6b 76 10 80       	push   $0x8010766b
...
80104a1e:	68 7a 76 10 80       	push   $0x8010767a
...
80104a2b:	68 5c 76 10 80       	push   $0x8010765c
...
80104e3d:	58                   	pop    %eax
80104e3e:	5a                   	pop    %edx
80104e3f:	68 78 76 10 80       	push   $0x80107678
...
80104e58:	68 77 76 10 80       	push   $0x80107677
...
80104eb2:	e8 69 f5 ff ff       	call   80104420 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104fad:	68 9c 76 10 80       	push   $0x8010769c
...
80104fba:	68 ae 76 10 80       	push   $0x801076ae
...
80104fc7:	68 8a 76 10 80       	push   $0x8010768a
...
80105338:	e8 e3 f0 ff ff       	call   80104420 <memset>
...
80105580:	68 60 4d 11 80       	push   $0x80114d60
...
8010558d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105590:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
801055a3:	68 60 4d 11 80       	push   $0x80114d60
801055a8:	68 a0 55 11 80       	push   $0x801155a0
801055ad:	e8 6e e7 ff ff       	call   80103d20 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801055b2:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
80105614:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105617:	68 60 4d 11 80       	push   $0x80114d60
8010561c:	e8 ff ec ff ff       	call   80104320 <acquire>
  xticks = ticks;
80105621:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
...
80105646:	e8 25 e1 ff ff       	call   80103770 <myproc>
8010564b:	8b 40 7c             	mov    0x7c(%eax),%eax
}
8010564e:	c9                   	leave  
8010564f:	c3                   	ret    
...
8010565f:	54                   	push   %esp
  call trap
80105660:	e8 eb 00 00 00       	call   80105750 <trap>
  addl $4, %esp
...
80105694:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
8010569b:	00 
8010569c:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
801056a3:	80 
801056a4:	c6 04 c5 a5 4d 11 80 	movb   $0x8e,-0x7feeb25b(,%eax,8)
801056ab:	8e 
801056ac:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
801056b3:	80 
801056b4:	c1 ea 10             	shr    $0x10,%edx
801056b7:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
801056be:	80 
void
tvinit(void)
{
...
801056d9:	68 bd 76 10 80       	push   $0x801076bd
801056de:	68 60 4d 11 80       	push   $0x80114d60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056e3:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
801056ea:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
801056f1:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801056f7:	c1 e8 10             	shr    $0x10,%eax
801056fa:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
80105701:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
...
80105770:	ff 24 85 64 77 10 80 	jmp    *-0x7fef889c(,%eax,4)
...
801057d5:	68 20 77 10 80       	push   $0x80107720
...
801058bf:	68 c8 76 10 80       	push   $0x801076c8
...
80105901:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105904:	e8 17 ef ff ff       	call   80104820 <syscall>
    if(myproc()->killed)
...
80105938:	e8 e3 e9 ff ff       	call   80104320 <acquire>
      ticks++;
      wakeup(&ticks);
8010593d:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105944:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010594b:	e8 90 e5 ff ff       	call   80103ee0 <wakeup>
      release(&tickslock);
80105950:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
...
80105978:	68 ec 76 10 80       	push   $0x801076ec
8010597d:	e8 de ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105982:	83 c4 14             	add    $0x14,%esp
80105985:	68 c2 76 10 80       	push   $0x801076c2
...
80105a7f:	bb e4 77 10 80       	mov    $0x801077e4,%ebx
...
80105b17:	6a 00                	push   $0x0
  jmp alltraps
80105b19:	e9 32 fb ff ff       	jmp    80105650 <alltraps>
...
80105b20:	6a 01                	push   $0x1
  jmp alltraps
80105b22:	e9 29 fb ff ff       	jmp    80105650 <alltraps>
...
80105b29:	6a 02                	push   $0x2
  jmp alltraps
80105b2b:	e9 20 fb ff ff       	jmp    80105650 <alltraps>
...
80105b32:	6a 03                	push   $0x3
  jmp alltraps
80105b34:	e9 17 fb ff ff       	jmp    80105650 <alltraps>
...
80105b3b:	6a 04                	push   $0x4
  jmp alltraps
80105b3d:	e9 0e fb ff ff       	jmp    80105650 <alltraps>
...
80105b44:	6a 05                	push   $0x5
  jmp alltraps
80105b46:	e9 05 fb ff ff       	jmp    80105650 <alltraps>
...
80105b4d:	6a 06                	push   $0x6
  jmp alltraps
80105b4f:	e9 fc fa ff ff       	jmp    80105650 <alltraps>
...
80105b56:	6a 07                	push   $0x7
  jmp alltraps
80105b58:	e9 f3 fa ff ff       	jmp    80105650 <alltraps>
...
80105b5d:	6a 08                	push   $0x8
  jmp alltraps
80105b5f:	e9 ec fa ff ff       	jmp    80105650 <alltraps>
...
80105b66:	6a 09                	push   $0x9
  jmp alltraps
80105b68:	e9 e3 fa ff ff       	jmp    80105650 <alltraps>
...
80105b6d:	6a 0a                	push   $0xa
  jmp alltraps
80105b6f:	e9 dc fa ff ff       	jmp    80105650 <alltraps>
...
80105b74:	6a 0b                	push   $0xb
  jmp alltraps
80105b76:	e9 d5 fa ff ff       	jmp    80105650 <alltraps>
...
80105b7b:	6a 0c                	push   $0xc
  jmp alltraps
80105b7d:	e9 ce fa ff ff       	jmp    80105650 <alltraps>
...
80105b82:	6a 0d                	push   $0xd
  jmp alltraps
80105b84:	e9 c7 fa ff ff       	jmp    80105650 <alltraps>
...
80105b89:	6a 0e                	push   $0xe
  jmp alltraps
80105b8b:	e9 c0 fa ff ff       	jmp    80105650 <alltraps>
...
80105b92:	6a 0f                	push   $0xf
  jmp alltraps
80105b94:	e9 b7 fa ff ff       	jmp    80105650 <alltraps>
...
80105b9b:	6a 10                	push   $0x10
  jmp alltraps
80105b9d:	e9 ae fa ff ff       	jmp    80105650 <alltraps>
...
80105ba2:	6a 11                	push   $0x11
  jmp alltraps
80105ba4:	e9 a7 fa ff ff       	jmp    80105650 <alltraps>
...
80105bab:	6a 12                	push   $0x12
  jmp alltraps
80105bad:	e9 9e fa ff ff       	jmp    80105650 <alltraps>
...
80105bb4:	6a 13                	push   $0x13
  jmp alltraps
80105bb6:	e9 95 fa ff ff       	jmp    80105650 <alltraps>
...
80105bbd:	6a 14                	push   $0x14
  jmp alltraps
80105bbf:	e9 8c fa ff ff       	jmp    80105650 <alltraps>
...
80105bc6:	6a 15                	push   $0x15
  jmp alltraps
80105bc8:	e9 83 fa ff ff       	jmp    80105650 <alltraps>
...
80105bcf:	6a 16                	push   $0x16
  jmp alltraps
80105bd1:	e9 7a fa ff ff       	jmp    80105650 <alltraps>
...
80105bd8:	6a 17                	push   $0x17
  jmp alltraps
80105bda:	e9 71 fa ff ff       	jmp    80105650 <alltraps>
...
80105be1:	6a 18                	push   $0x18
  jmp alltraps
80105be3:	e9 68 fa ff ff       	jmp    80105650 <alltraps>
...
80105bea:	6a 19                	push   $0x19
  jmp alltraps
80105bec:	e9 5f fa ff ff       	jmp    80105650 <alltraps>
...
80105bf3:	6a 1a                	push   $0x1a
  jmp alltraps
80105bf5:	e9 56 fa ff ff       	jmp    80105650 <alltraps>
...
80105bfc:	6a 1b                	push   $0x1b
  jmp alltraps
80105bfe:	e9 4d fa ff ff       	jmp    80105650 <alltraps>
...
80105c05:	6a 1c                	push   $0x1c
  jmp alltraps
80105c07:	e9 44 fa ff ff       	jmp    80105650 <alltraps>
...
80105c0e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c10:	e9 3b fa ff ff       	jmp    80105650 <alltraps>
...
80105c17:	6a 1e                	push   $0x1e
  jmp alltraps
80105c19:	e9 32 fa ff ff       	jmp    80105650 <alltraps>
...
80105c20:	6a 1f                	push   $0x1f
  jmp alltraps
80105c22:	e9 29 fa ff ff       	jmp    80105650 <alltraps>
...
80105c29:	6a 20                	push   $0x20
  jmp alltraps
80105c2b:	e9 20 fa ff ff       	jmp    80105650 <alltraps>
...
80105c32:	6a 21                	push   $0x21
  jmp alltraps
80105c34:	e9 17 fa ff ff       	jmp    80105650 <alltraps>
...
80105c3b:	6a 22                	push   $0x22
  jmp alltraps
80105c3d:	e9 0e fa ff ff       	jmp    80105650 <alltraps>
...
80105c44:	6a 23                	push   $0x23
  jmp alltraps
80105c46:	e9 05 fa ff ff       	jmp    80105650 <alltraps>
...
80105c4d:	6a 24                	push   $0x24
  jmp alltraps
80105c4f:	e9 fc f9 ff ff       	jmp    80105650 <alltraps>
...
80105c56:	6a 25                	push   $0x25
  jmp alltraps
80105c58:	e9 f3 f9 ff ff       	jmp    80105650 <alltraps>
...
80105c5f:	6a 26                	push   $0x26
  jmp alltraps
80105c61:	e9 ea f9 ff ff       	jmp    80105650 <alltraps>
...
80105c68:	6a 27                	push   $0x27
  jmp alltraps
80105c6a:	e9 e1 f9 ff ff       	jmp    80105650 <alltraps>
...
80105c71:	6a 28                	push   $0x28
  jmp alltraps
80105c73:	e9 d8 f9 ff ff       	jmp    80105650 <alltraps>
...
80105c7a:	6a 29                	push   $0x29
  jmp alltraps
80105c7c:	e9 cf f9 ff ff       	jmp    80105650 <alltraps>
...
80105c83:	6a 2a                	push   $0x2a
  jmp alltraps
80105c85:	e9 c6 f9 ff ff       	jmp    80105650 <alltraps>
...
80105c8c:	6a 2b                	push   $0x2b
  jmp alltraps
80105c8e:	e9 bd f9 ff ff       	jmp    80105650 <alltraps>
...
80105c95:	6a 2c                	push   $0x2c
  jmp alltraps
80105c97:	e9 b4 f9 ff ff       	jmp    80105650 <alltraps>
...
80105c9e:	6a 2d                	push   $0x2d
  jmp alltraps
80105ca0:	e9 ab f9 ff ff       	jmp    80105650 <alltraps>
...
80105ca7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ca9:	e9 a2 f9 ff ff       	jmp    80105650 <alltraps>
...
80105cb0:	6a 2f                	push   $0x2f
  jmp alltraps
80105cb2:	e9 99 f9 ff ff       	jmp    80105650 <alltraps>
...
80105cb9:	6a 30                	push   $0x30
  jmp alltraps
80105cbb:	e9 90 f9 ff ff       	jmp    80105650 <alltraps>
...
80105cc2:	6a 31                	push   $0x31
  jmp alltraps
80105cc4:	e9 87 f9 ff ff       	jmp    80105650 <alltraps>
...
80105ccb:	6a 32                	push   $0x32
  jmp alltraps
80105ccd:	e9 7e f9 ff ff       	jmp    80105650 <alltraps>
...
80105cd4:	6a 33                	push   $0x33
  jmp alltraps
80105cd6:	e9 75 f9 ff ff       	jmp    80105650 <alltraps>
...
80105cdd:	6a 34                	push   $0x34
  jmp alltraps
80105cdf:	e9 6c f9 ff ff       	jmp    80105650 <alltraps>
...
80105ce6:	6a 35                	push   $0x35
  jmp alltraps
80105ce8:	e9 63 f9 ff ff       	jmp    80105650 <alltraps>
...
80105cef:	6a 36                	push   $0x36
  jmp alltraps
80105cf1:	e9 5a f9 ff ff       	jmp    80105650 <alltraps>
...
80105cf8:	6a 37                	push   $0x37
  jmp alltraps
80105cfa:	e9 51 f9 ff ff       	jmp    80105650 <alltraps>
...
80105d01:	6a 38                	push   $0x38
  jmp alltraps
80105d03:	e9 48 f9 ff ff       	jmp    80105650 <alltraps>
...
80105d0a:	6a 39                	push   $0x39
  jmp alltraps
80105d0c:	e9 3f f9 ff ff       	jmp    80105650 <alltraps>
...
80105d13:	6a 3a                	push   $0x3a
  jmp alltraps
80105d15:	e9 36 f9 ff ff       	jmp    80105650 <alltraps>
...
80105d1c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d1e:	e9 2d f9 ff ff       	jmp    80105650 <alltraps>
...
80105d25:	6a 3c                	push   $0x3c
  jmp alltraps
80105d27:	e9 24 f9 ff ff       	jmp    80105650 <alltraps>
...
80105d2e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d30:	e9 1b f9 ff ff       	jmp    80105650 <alltraps>
...
80105d37:	6a 3e                	push   $0x3e
  jmp alltraps
80105d39:	e9 12 f9 ff ff       	jmp    80105650 <alltraps>
...
80105d40:	6a 3f                	push   $0x3f
  jmp alltraps
80105d42:	e9 09 f9 ff ff       	jmp    80105650 <alltraps>
...
80105d49:	6a 40                	push   $0x40
  jmp alltraps
80105d4b:	e9 00 f9 ff ff       	jmp    80105650 <alltraps>
...
80105d52:	6a 41                	push   $0x41
  jmp alltraps
80105d54:	e9 f7 f8 ff ff       	jmp    80105650 <alltraps>
...
80105d5b:	6a 42                	push   $0x42
  jmp alltraps
80105d5d:	e9 ee f8 ff ff       	jmp    80105650 <alltraps>
...
80105d64:	6a 43                	push   $0x43
  jmp alltraps
80105d66:	e9 e5 f8 ff ff       	jmp    80105650 <alltraps>
...
80105d6d:	6a 44                	push   $0x44
  jmp alltraps
80105d6f:	e9 dc f8 ff ff       	jmp    80105650 <alltraps>
...
80105d76:	6a 45                	push   $0x45
  jmp alltraps
80105d78:	e9 d3 f8 ff ff       	jmp    80105650 <alltraps>
...
80105d7f:	6a 46                	push   $0x46
  jmp alltraps
80105d81:	e9 ca f8 ff ff       	jmp    80105650 <alltraps>
...
80105d88:	6a 47                	push   $0x47
  jmp alltraps
80105d8a:	e9 c1 f8 ff ff       	jmp    80105650 <alltraps>
...
80105d91:	6a 48                	push   $0x48
  jmp alltraps
80105d93:	e9 b8 f8 ff ff       	jmp    80105650 <alltraps>
...
80105d9a:	6a 49                	push   $0x49
  jmp alltraps
80105d9c:	e9 af f8 ff ff       	jmp    80105650 <alltraps>
...
80105da3:	6a 4a                	push   $0x4a
  jmp alltraps
80105da5:	e9 a6 f8 ff ff       	jmp    80105650 <alltraps>
...
80105dac:	6a 4b                	push   $0x4b
  jmp alltraps
80105dae:	e9 9d f8 ff ff       	jmp    80105650 <alltraps>
...
80105db5:	6a 4c                	push   $0x4c
  jmp alltraps
80105db7:	e9 94 f8 ff ff       	jmp    80105650 <alltraps>
...
80105dbe:	6a 4d                	push   $0x4d
  jmp alltraps
80105dc0:	e9 8b f8 ff ff       	jmp    80105650 <alltraps>
...
80105dc7:	6a 4e                	push   $0x4e
  jmp alltraps
80105dc9:	e9 82 f8 ff ff       	jmp    80105650 <alltraps>
...
80105dd0:	6a 4f                	push   $0x4f
  jmp alltraps
80105dd2:	e9 79 f8 ff ff       	jmp    80105650 <alltraps>
...
80105dd9:	6a 50                	push   $0x50
  jmp alltraps
80105ddb:	e9 70 f8 ff ff       	jmp    80105650 <alltraps>
...
80105de2:	6a 51                	push   $0x51
  jmp alltraps
80105de4:	e9 67 f8 ff ff       	jmp    80105650 <alltraps>
...
80105deb:	6a 52                	push   $0x52
  jmp alltraps
80105ded:	e9 5e f8 ff ff       	jmp    80105650 <alltraps>
...
80105df4:	6a 53                	push   $0x53
  jmp alltraps
80105df6:	e9 55 f8 ff ff       	jmp    80105650 <alltraps>
...
80105dfd:	6a 54                	push   $0x54
  jmp alltraps
80105dff:	e9 4c f8 ff ff       	jmp    80105650 <alltraps>
...
80105e06:	6a 55                	push   $0x55
  jmp alltraps
80105e08:	e9 43 f8 ff ff       	jmp    80105650 <alltraps>
...
80105e0f:	6a 56                	push   $0x56
  jmp alltraps
80105e11:	e9 3a f8 ff ff       	jmp    80105650 <alltraps>
...
80105e18:	6a 57                	push   $0x57
  jmp alltraps
80105e1a:	e9 31 f8 ff ff       	jmp    80105650 <alltraps>
...
80105e21:	6a 58                	push   $0x58
  jmp alltraps
80105e23:	e9 28 f8 ff ff       	jmp    80105650 <alltraps>
...
80105e2a:	6a 59                	push   $0x59
  jmp alltraps
80105e2c:	e9 1f f8 ff ff       	jmp    80105650 <alltraps>
...
80105e33:	6a 5a                	push   $0x5a
  jmp alltraps
80105e35:	e9 16 f8 ff ff       	jmp    80105650 <alltraps>
...
80105e3c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e3e:	e9 0d f8 ff ff       	jmp    80105650 <alltraps>
...
80105e45:	6a 5c                	push   $0x5c
  jmp alltraps
80105e47:	e9 04 f8 ff ff       	jmp    80105650 <alltraps>
...
80105e4e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e50:	e9 fb f7 ff ff       	jmp    80105650 <alltraps>
...
80105e57:	6a 5e                	push   $0x5e
  jmp alltraps
80105e59:	e9 f2 f7 ff ff       	jmp    80105650 <alltraps>
...
80105e60:	6a 5f                	push   $0x5f
  jmp alltraps
80105e62:	e9 e9 f7 ff ff       	jmp    80105650 <alltraps>
...
80105e69:	6a 60                	push   $0x60
  jmp alltraps
80105e6b:	e9 e0 f7 ff ff       	jmp    80105650 <alltraps>
...
80105e72:	6a 61                	push   $0x61
  jmp alltraps
80105e74:	e9 d7 f7 ff ff       	jmp    80105650 <alltraps>
...
80105e7b:	6a 62                	push   $0x62
  jmp alltraps
80105e7d:	e9 ce f7 ff ff       	jmp    80105650 <alltraps>
...
80105e84:	6a 63                	push   $0x63
  jmp alltraps
80105e86:	e9 c5 f7 ff ff       	jmp    80105650 <alltraps>
...
80105e8d:	6a 64                	push   $0x64
  jmp alltraps
80105e8f:	e9 bc f7 ff ff       	jmp    80105650 <alltraps>
...
80105e96:	6a 65                	push   $0x65
  jmp alltraps
80105e98:	e9 b3 f7 ff ff       	jmp    80105650 <alltraps>
...
80105e9f:	6a 66                	push   $0x66
  jmp alltraps
80105ea1:	e9 aa f7 ff ff       	jmp    80105650 <alltraps>
...
80105ea8:	6a 67                	push   $0x67
  jmp alltraps
80105eaa:	e9 a1 f7 ff ff       	jmp    80105650 <alltraps>
...
80105eb1:	6a 68                	push   $0x68
  jmp alltraps
80105eb3:	e9 98 f7 ff ff       	jmp    80105650 <alltraps>
...
80105eba:	6a 69                	push   $0x69
  jmp alltraps
80105ebc:	e9 8f f7 ff ff       	jmp    80105650 <alltraps>
...
80105ec3:	6a 6a                	push   $0x6a
  jmp alltraps
80105ec5:	e9 86 f7 ff ff       	jmp    80105650 <alltraps>
...
80105ecc:	6a 6b                	push   $0x6b
  jmp alltraps
80105ece:	e9 7d f7 ff ff       	jmp    80105650 <alltraps>
...
80105ed5:	6a 6c                	push   $0x6c
  jmp alltraps
80105ed7:	e9 74 f7 ff ff       	jmp    80105650 <alltraps>
...
80105ede:	6a 6d                	push   $0x6d
  jmp alltraps
80105ee0:	e9 6b f7 ff ff       	jmp    80105650 <alltraps>
...
80105ee7:	6a 6e                	push   $0x6e
  jmp alltraps
80105ee9:	e9 62 f7 ff ff       	jmp    80105650 <alltraps>
...
80105ef0:	6a 6f                	push   $0x6f
  jmp alltraps
80105ef2:	e9 59 f7 ff ff       	jmp    80105650 <alltraps>
...
80105ef9:	6a 70                	push   $0x70
  jmp alltraps
80105efb:	e9 50 f7 ff ff       	jmp    80105650 <alltraps>
...
80105f02:	6a 71                	push   $0x71
  jmp alltraps
80105f04:	e9 47 f7 ff ff       	jmp    80105650 <alltraps>
...
80105f0b:	6a 72                	push   $0x72
  jmp alltraps
80105f0d:	e9 3e f7 ff ff       	jmp    80105650 <alltraps>
...
80105f14:	6a 73                	push   $0x73
  jmp alltraps
80105f16:	e9 35 f7 ff ff       	jmp    80105650 <alltraps>
...
80105f1d:	6a 74                	push   $0x74
  jmp alltraps
80105f1f:	e9 2c f7 ff ff       	jmp    80105650 <alltraps>
...
80105f26:	6a 75                	push   $0x75
  jmp alltraps
80105f28:	e9 23 f7 ff ff       	jmp    80105650 <alltraps>
...
80105f2f:	6a 76                	push   $0x76
  jmp alltraps
80105f31:	e9 1a f7 ff ff       	jmp    80105650 <alltraps>
...
80105f38:	6a 77                	push   $0x77
  jmp alltraps
80105f3a:	e9 11 f7 ff ff       	jmp    80105650 <alltraps>
...
80105f41:	6a 78                	push   $0x78
  jmp alltraps
80105f43:	e9 08 f7 ff ff       	jmp    80105650 <alltraps>
...
80105f4a:	6a 79                	push   $0x79
  jmp alltraps
80105f4c:	e9 ff f6 ff ff       	jmp    80105650 <alltraps>
...
80105f53:	6a 7a                	push   $0x7a
  jmp alltraps
80105f55:	e9 f6 f6 ff ff       	jmp    80105650 <alltraps>
...
80105f5c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f5e:	e9 ed f6 ff ff       	jmp    80105650 <alltraps>
...
80105f65:	6a 7c                	push   $0x7c
  jmp alltraps
80105f67:	e9 e4 f6 ff ff       	jmp    80105650 <alltraps>
...
80105f6e:	6a 7d                	push   $0x7d
  jmp alltraps
80105f70:	e9 db f6 ff ff       	jmp    80105650 <alltraps>
...
80105f80:	6a 7f                	push   $0x7f
  jmp alltraps
80105f82:	e9 c9 f6 ff ff       	jmp    80105650 <alltraps>
...
80105f89:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f8e:	e9 bd f6 ff ff       	jmp    80105650 <alltraps>
...
80105f95:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f9a:	e9 b1 f6 ff ff       	jmp    80105650 <alltraps>
...
80105fa1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fa6:	e9 a5 f6 ff ff       	jmp    80105650 <alltraps>
...
80105fad:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105fb2:	e9 99 f6 ff ff       	jmp    80105650 <alltraps>
...
80105fb9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105fbe:	e9 8d f6 ff ff       	jmp    80105650 <alltraps>
...
80105fc5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105fca:	e9 81 f6 ff ff       	jmp    80105650 <alltraps>
...
80105fd1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105fd6:	e9 75 f6 ff ff       	jmp    80105650 <alltraps>
...
80105fdd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105fe2:	e9 69 f6 ff ff       	jmp    80105650 <alltraps>
...
80105fe9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105fee:	e9 5d f6 ff ff       	jmp    80105650 <alltraps>
...
80105ff5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105ffa:	e9 51 f6 ff ff       	jmp    80105650 <alltraps>
...
80106001:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106006:	e9 45 f6 ff ff       	jmp    80105650 <alltraps>
...
8010600d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106012:	e9 39 f6 ff ff       	jmp    80105650 <alltraps>
...
80106019:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010601e:	e9 2d f6 ff ff       	jmp    80105650 <alltraps>
...
80106025:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010602a:	e9 21 f6 ff ff       	jmp    80105650 <alltraps>
...
80106031:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106036:	e9 15 f6 ff ff       	jmp    80105650 <alltraps>
...
8010603d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106042:	e9 09 f6 ff ff       	jmp    80105650 <alltraps>
...
80106049:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010604e:	e9 fd f5 ff ff       	jmp    80105650 <alltraps>
...
80106055:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010605a:	e9 f1 f5 ff ff       	jmp    80105650 <alltraps>
...
80106061:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106066:	e9 e5 f5 ff ff       	jmp    80105650 <alltraps>
...
8010606d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106072:	e9 d9 f5 ff ff       	jmp    80105650 <alltraps>
...
80106079:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010607e:	e9 cd f5 ff ff       	jmp    80105650 <alltraps>
...
80106085:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010608a:	e9 c1 f5 ff ff       	jmp    80105650 <alltraps>
...
80106091:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106096:	e9 b5 f5 ff ff       	jmp    80105650 <alltraps>
...
8010609d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060a2:	e9 a9 f5 ff ff       	jmp    80105650 <alltraps>
...
801060a9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060ae:	e9 9d f5 ff ff       	jmp    80105650 <alltraps>
...
801060b5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060ba:	e9 91 f5 ff ff       	jmp    80105650 <alltraps>
...
801060c1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801060c6:	e9 85 f5 ff ff       	jmp    80105650 <alltraps>
...
801060cd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801060d2:	e9 79 f5 ff ff       	jmp    80105650 <alltraps>
...
801060d9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801060de:	e9 6d f5 ff ff       	jmp    80105650 <alltraps>
...
801060e5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060ea:	e9 61 f5 ff ff       	jmp    80105650 <alltraps>
...
801060f1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801060f6:	e9 55 f5 ff ff       	jmp    80105650 <alltraps>
...
801060fd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106102:	e9 49 f5 ff ff       	jmp    80105650 <alltraps>
...
80106109:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010610e:	e9 3d f5 ff ff       	jmp    80105650 <alltraps>
...
80106115:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010611a:	e9 31 f5 ff ff       	jmp    80105650 <alltraps>
...
80106121:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106126:	e9 25 f5 ff ff       	jmp    80105650 <alltraps>
...
8010612d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106132:	e9 19 f5 ff ff       	jmp    80105650 <alltraps>
...
80106139:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010613e:	e9 0d f5 ff ff       	jmp    80105650 <alltraps>
...
80106145:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010614a:	e9 01 f5 ff ff       	jmp    80105650 <alltraps>
...
80106151:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106156:	e9 f5 f4 ff ff       	jmp    80105650 <alltraps>
...
8010615d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106162:	e9 e9 f4 ff ff       	jmp    80105650 <alltraps>
...
80106169:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010616e:	e9 dd f4 ff ff       	jmp    80105650 <alltraps>
...
80106175:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010617a:	e9 d1 f4 ff ff       	jmp    80105650 <alltraps>
...
80106181:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106186:	e9 c5 f4 ff ff       	jmp    80105650 <alltraps>
...
8010618d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106192:	e9 b9 f4 ff ff       	jmp    80105650 <alltraps>
...
80106199:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010619e:	e9 ad f4 ff ff       	jmp    80105650 <alltraps>
...
801061a5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061aa:	e9 a1 f4 ff ff       	jmp    80105650 <alltraps>
...
801061b1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061b6:	e9 95 f4 ff ff       	jmp    80105650 <alltraps>
...
801061bd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801061c2:	e9 89 f4 ff ff       	jmp    80105650 <alltraps>
...
801061c9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801061ce:	e9 7d f4 ff ff       	jmp    80105650 <alltraps>
...
801061d5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801061da:	e9 71 f4 ff ff       	jmp    80105650 <alltraps>
...
801061e1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061e6:	e9 65 f4 ff ff       	jmp    80105650 <alltraps>
...
801061ed:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801061f2:	e9 59 f4 ff ff       	jmp    80105650 <alltraps>
...
801061f9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801061fe:	e9 4d f4 ff ff       	jmp    80105650 <alltraps>
...
80106205:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010620a:	e9 41 f4 ff ff       	jmp    80105650 <alltraps>
...
80106211:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106216:	e9 35 f4 ff ff       	jmp    80105650 <alltraps>
...
8010621d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106222:	e9 29 f4 ff ff       	jmp    80105650 <alltraps>
...
80106229:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010622e:	e9 1d f4 ff ff       	jmp    80105650 <alltraps>
...
80106235:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010623a:	e9 11 f4 ff ff       	jmp    80105650 <alltraps>
...
80106241:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106246:	e9 05 f4 ff ff       	jmp    80105650 <alltraps>
...
8010624d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106252:	e9 f9 f3 ff ff       	jmp    80105650 <alltraps>
...
80106259:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010625e:	e9 ed f3 ff ff       	jmp    80105650 <alltraps>
...
80106265:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010626a:	e9 e1 f3 ff ff       	jmp    80105650 <alltraps>
...
80106271:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106276:	e9 d5 f3 ff ff       	jmp    80105650 <alltraps>
...
8010627d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106282:	e9 c9 f3 ff ff       	jmp    80105650 <alltraps>
...
80106289:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010628e:	e9 bd f3 ff ff       	jmp    80105650 <alltraps>
...
80106295:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010629a:	e9 b1 f3 ff ff       	jmp    80105650 <alltraps>
...
801062a1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062a6:	e9 a5 f3 ff ff       	jmp    80105650 <alltraps>
...
801062ad:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062b2:	e9 99 f3 ff ff       	jmp    80105650 <alltraps>
...
801062b9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062be:	e9 8d f3 ff ff       	jmp    80105650 <alltraps>
...
801062c5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801062ca:	e9 81 f3 ff ff       	jmp    80105650 <alltraps>
...
801062d1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801062d6:	e9 75 f3 ff ff       	jmp    80105650 <alltraps>
...
801062dd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062e2:	e9 69 f3 ff ff       	jmp    80105650 <alltraps>
...
801062e9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062ee:	e9 5d f3 ff ff       	jmp    80105650 <alltraps>
...
801062f5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801062fa:	e9 51 f3 ff ff       	jmp    80105650 <alltraps>
...
80106301:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106306:	e9 45 f3 ff ff       	jmp    80105650 <alltraps>
...
8010630d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106312:	e9 39 f3 ff ff       	jmp    80105650 <alltraps>
...
80106319:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010631e:	e9 2d f3 ff ff       	jmp    80105650 <alltraps>
...
80106325:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010632a:	e9 21 f3 ff ff       	jmp    80105650 <alltraps>
...
80106331:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106336:	e9 15 f3 ff ff       	jmp    80105650 <alltraps>
...
8010633d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106342:	e9 09 f3 ff ff       	jmp    80105650 <alltraps>
...
80106349:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010634e:	e9 fd f2 ff ff       	jmp    80105650 <alltraps>
...
80106355:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010635a:	e9 f1 f2 ff ff       	jmp    80105650 <alltraps>
...
80106361:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106366:	e9 e5 f2 ff ff       	jmp    80105650 <alltraps>
...
8010636d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106372:	e9 d9 f2 ff ff       	jmp    80105650 <alltraps>
...
80106379:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010637e:	e9 cd f2 ff ff       	jmp    80105650 <alltraps>
...
80106385:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010638a:	e9 c1 f2 ff ff       	jmp    80105650 <alltraps>
...
80106391:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106396:	e9 b5 f2 ff ff       	jmp    80105650 <alltraps>
...
8010639d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063a2:	e9 a9 f2 ff ff       	jmp    80105650 <alltraps>
...
801063a9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063ae:	e9 9d f2 ff ff       	jmp    80105650 <alltraps>
...
801063b5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063ba:	e9 91 f2 ff ff       	jmp    80105650 <alltraps>
...
801063c1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801063c6:	e9 85 f2 ff ff       	jmp    80105650 <alltraps>
...
801063cd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801063d2:	e9 79 f2 ff ff       	jmp    80105650 <alltraps>
...
801063d9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801063de:	e9 6d f2 ff ff       	jmp    80105650 <alltraps>
...
801063e5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063ea:	e9 61 f2 ff ff       	jmp    80105650 <alltraps>
...
801063f1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801063f6:	e9 55 f2 ff ff       	jmp    80105650 <alltraps>
...
801063fd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106402:	e9 49 f2 ff ff       	jmp    80105650 <alltraps>
...
80106409:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010640e:	e9 3d f2 ff ff       	jmp    80105650 <alltraps>
...
80106415:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010641a:	e9 31 f2 ff ff       	jmp    80105650 <alltraps>
...
80106421:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106426:	e9 25 f2 ff ff       	jmp    80105650 <alltraps>
...
8010642d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106432:	e9 19 f2 ff ff       	jmp    80105650 <alltraps>
...
80106439:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010643e:	e9 0d f2 ff ff       	jmp    80105650 <alltraps>
...
80106445:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010644a:	e9 01 f2 ff ff       	jmp    80105650 <alltraps>
...
80106451:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106456:	e9 f5 f1 ff ff       	jmp    80105650 <alltraps>
...
8010645d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106462:	e9 e9 f1 ff ff       	jmp    80105650 <alltraps>
...
80106469:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010646e:	e9 dd f1 ff ff       	jmp    80105650 <alltraps>
...
80106475:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010647a:	e9 d1 f1 ff ff       	jmp    80105650 <alltraps>
...
80106481:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106486:	e9 c5 f1 ff ff       	jmp    80105650 <alltraps>
...
8010648d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106492:	e9 b9 f1 ff ff       	jmp    80105650 <alltraps>
...
80106499:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010649e:	e9 ad f1 ff ff       	jmp    80105650 <alltraps>
...
801064a5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064aa:	e9 a1 f1 ff ff       	jmp    80105650 <alltraps>
...
801064b1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064b6:	e9 95 f1 ff ff       	jmp    80105650 <alltraps>
...
801064bd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801064c2:	e9 89 f1 ff ff       	jmp    80105650 <alltraps>
...
801064c9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801064ce:	e9 7d f1 ff ff       	jmp    80105650 <alltraps>
...
801064d5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801064da:	e9 71 f1 ff ff       	jmp    80105650 <alltraps>
...
801064e1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064e6:	e9 65 f1 ff ff       	jmp    80105650 <alltraps>
...
801064ed:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801064f2:	e9 59 f1 ff ff       	jmp    80105650 <alltraps>
...
801064f9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801064fe:	e9 4d f1 ff ff       	jmp    80105650 <alltraps>
...
80106505:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010650a:	e9 41 f1 ff ff       	jmp    80105650 <alltraps>
...
80106511:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106516:	e9 35 f1 ff ff       	jmp    80105650 <alltraps>
...
8010651d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106522:	e9 29 f1 ff ff       	jmp    80105650 <alltraps>
...
80106529:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010652e:	e9 1d f1 ff ff       	jmp    80105650 <alltraps>
...
80106535:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010653a:	e9 11 f1 ff ff       	jmp    80105650 <alltraps>
...
80106541:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106546:	e9 05 f1 ff ff       	jmp    80105650 <alltraps>
...
8010654d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106552:	e9 f9 f0 ff ff       	jmp    80105650 <alltraps>
...
80106559:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010655e:	e9 ed f0 ff ff       	jmp    80105650 <alltraps>
...
80106565:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010656a:	e9 e1 f0 ff ff       	jmp    80105650 <alltraps>
...
80106571:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106576:	e9 d5 f0 ff ff       	jmp    80105650 <alltraps>
...
8010657d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106582:	e9 c9 f0 ff ff       	jmp    80105650 <alltraps>
...
8010668d:	68 ec 77 10 80       	push   $0x801077ec
...
80106884:	0f 84 c4 00 00 00    	je     8010694e <switchuvm+0xee>
  ...
  pushcli();
8010688a:	e8 b1 d9 ff ff       	call   80104240 <pushcli>
...
8010693b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010693c:	e9 3f d9 ff ff       	jmp    80104280 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106944:	68 f2 77 10 80       	push   $0x801077f2
...
80106951:	68 1d 78 10 80       	push   $0x8010781d
...
8010695e:	68 08 78 10 80       	push   $0x80107808
...
8010699f:	e8 7c da ff ff       	call   80104420 <memset>
...
801069d0:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801069d1:	e9 fa da ff ff       	jmp    801044d0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
801069d9:	68 31 78 10 80       	push   $0x80107831
...
80106a8d:	68 4b 78 10 80       	push   $0x8010784b
...
80106a9a:	68 ec 78 10 80       	push   $0x801078ec
...
80106af3:	e8 28 d9 ff ff       	call   80104420 <memset>
...
80106b31:	68 69 78 10 80       	push   $0x80107869
...
80106b63:	68 81 78 10 80       	push   $0x80107881
...
80106c4c:	68 9d 78 10 80       	push   $0x8010789d
...
80106c80:	e8 9b d7 ff ff       	call   80104420 <memset>
...
80106d1f:	68 ae 78 10 80       	push   $0x801078ae
...
80106d70:	e8 5b d7 ff ff       	call   801044d0 <memmove>
...
80106e15:	68 d2 78 10 80       	push   $0x801078d2
...
80106e22:	68 b8 78 10 80       	push   $0x801078b8
...
80106eaf:	e8 1c d6 ff ff       	call   801044d0 <memmove>
    len -= n;
    buf += n;
